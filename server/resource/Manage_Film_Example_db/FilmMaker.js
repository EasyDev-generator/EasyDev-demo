...
app.post(properties.api + '/filmmaker', function(req, res){
...
app['delete'](properties.api + '/filmmaker/:id', function(req, res){
...
app.get(properties.api + '/filmmaker/:id', function(req, res){
...
app.get(properties.api + '/filmmaker', function(req, res){
...
app.post(properties.api + '/filmmaker/:id', function(req, res){
